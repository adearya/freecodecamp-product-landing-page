...
<img src="https://raw.githubusercontent.com/adearya/freecodecamp-product-landing-page/HEAD/raw/images/github_user_logo.jpeg" alt="Github User Logo" width="80" height="80">

<h3 align="center">Product Landing Page - By freeCodeCamp</h3>
    <p align="center">
        I created this project as part of a freeCodeCamp certification, focusing on minimalist design principles and effective product presentation.
    </p>
</div>
...
![App Screenshot](https://raw.githubusercontent.com/adearya/freecodecamp-product-landing-page/HEAD/raw/images/desktop_screenshot.png)

<p align="center">
    This project was developed using TailwindCSS, ensuring a modern, sleek, and lightweight design. It includes essential sections such as product features, pricing, testimonials, and a call-to-action, all optimized for usability and accessibility.
</p>
...
<p>
    Users can explore a clean and responsive landing page designed for product marketing, ensuring a smooth experience across different screen sizes.
</p>
...
Clone the repo
```sh
git clone https://github.com/adearya/freecodecamp-product-landing-page.git
```
Change directory
```sh
cd freecodecamp-product-landing-page/
```
<!-- add_installation -->
